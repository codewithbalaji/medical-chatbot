...
const FaqSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "No, our AI assistant cannot provide diagnoses. It can help explain medical concepts, conditions, and general information about women's health, but proper diagnosis requires in-person evaluation by a qualified healthcare provider who can review your complete medical history and perform appropriate examinations and tests.",
    },
    {
      question: "Is my data safe?",
      answer:
        "Yes, we take data privacy seriously. Your conversations are anonymous and we don't store any personally identifiable information. We use industry-standard encryption to protect all data. The information you provide is only used to generate relevant responses to your questions.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. If you're experiencing a medical emergency, please call emergency services (911 in the US) or go to your nearest emergency room immediately. Our AI assistant is not designed to handle emergencies and cannot provide urgent care or advice.",
    },
    {
    ...
    <section id="faq" className="py-16 bg-white">
      <div className="section-container">
        ...
        <p className="section-subtitle">
          Find answers to common questions about our AI women's health assistant
        </p>
